...
export default function HowItWorks() {
  return (
    <section className="relative overflow-hidden px-6 py-24">
      <div
        className="pointer-events-none absolute -top-24 right-1/4 h-96 w-96 rounded-full opacity-25 blur-3xl"
        style={{ background: "var(--color-teal-400)" }}
      />
      <div
        className="pointer-events-none absolute -bottom-28 left-1/4 h-80 w-80 rounded-full opacity-20 blur-3xl"
      ...
      <div className="relative mx-auto max-w-4xl">
        <Reveal className="text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold md:text-4xl">Know before you have to ask</h2>
        </Reveal>

        <Reveal delay={0.1}>
          <div className="relative mt-10 rounded-3xl bg-white p-10 text-center shadow-xl ring-1 ring-black/5 md:p-14">
            <motion.p
